...
export const SettingsSchema = z.object({
    ...
    voiceCustomAgentId: z.string().nullable().describe('Custom voice provider id. Use "soniox" to switch to Soniox STT, otherwise treated as ElevenLabs agent ID'),
    ...
    voiceSourceLanguage: z.string().nullable().describe('Soniox source language hint (null = auto)'),
    voiceStopWord: z.string().nullable().describe('Stop word to auto-finalize Soniox transcription'),
    voiceSonioxApiKey: z.string().nullable().describe('Soniox API key. Client connects directly to wss://stt-rt.soniox.com — no server proxy.'),
    voiceLlmCorrectionApiKey: z.string().nullable().describe('OpenAI-compatible API key for LLM correction. Correction auto-enables when this, base URL, and model are all set.'),
    voiceLlmCorrectionBaseUrl: z.string().nullable().describe('OpenAI-compatible base URL for LLM correction (e.g. https://api.openai.com/v1)'),
    voiceLlmCorrectionModel: z.string().nullable().describe('Model name used for LLM correction (e.g. gpt-4o-mini)'),
    voiceLlmCorrectionKeywords: z.string().nullable().describe('Comma-separated correction keywords/glossary (proper nouns, technical terms) injected into the LLM correction system prompt.'),
...
export const settingsDefaults: Settings = {
    ...
    voiceStopWord: null,
    voiceSonioxApiKey: null,
    voiceLlmCorrectionApiKey: null,
    voiceLlmCorrectionBaseUrl: null,
    voiceLlmCorrectionModel: null,
    voiceLlmCorrectionKeywords: null,
